export const initialTemples = [
  {
    ...
    rating: 4.9,
    image: "https://images.unsplash.com/photo-1627894732644-8d4841de6074?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    rating: 4.7,
    image: "https://images.unsplash.com/photo-1621872173167-a02ff6ee049b?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    rating: 4.9,
    image: "https://images.unsplash.com/photo-1588537549079-0524a4d62b5d?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    festivals: [
      ...
      { name: "Guru Nanak Jayanti", month: "November", significance: "Birth anniversary of the founder of Sikhism, illuminated with fireworks." }
    ],
    guidelines: {
      ...
      rules: [
        ...
        "Tobacco, alcohol, and drugs are strictly forbidden. You cannot enter under their influence.",
  ...
  },
  {
    ...
    rating: 4.8,
    image: "https://images.unsplash.com/photo-1620054624829-f83624f2b604?auto=format&fit=crop&w=800&q=80",
    ...
    facilities: {
      accommodation: true,
      transport: ["Keshod Airport (55km away)", "Diù Airport (85km away)", "Veraval Railway Station (7km away)", "Regular bus connections from Rajkot/Ahmedabad"],
